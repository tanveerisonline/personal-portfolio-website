...
for (let i = 0; i < modals.length; i += 1) {
  modalSection.innerHTML += `
          ...
          <div class="modal-bg ">
              ...
              <img src="${
                modals[i].imgCard
              }" class="work-img modal-img" alt="Portfolio Image">
              <div class="make-flex modal-structure">
                ...
                <div>
                  ...
                  <div class="modal-btn-group">
                    <button onClick="" class="default_about_button btn modal-btn">See Live <i class="fa-sharp fa-solid fa-earth-americas"></i></button>
                    <button onClick="" class="default_about_button btn modal-btn">See Source <i class="fa-brands fa-github"></i></button>
                  </div>
                </div>
              </div>
            </div>`;
